...
export class Updaterelation1742815873252 implements MigrationInterface {
    name = 'Updaterelation1742815873252'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "userHistory" ("userId" integer NOT NULL, "allVideosId" integer NOT NULL, CONSTRAINT "PK_c141762cd2f3697a1e790a4ce82" PRIMARY KEY ("userId", "allVideosId"))`);
